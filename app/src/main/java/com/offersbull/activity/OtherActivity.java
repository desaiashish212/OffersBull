...
public class OtherActivity extends AppCompatActivity implements Paginate.Callbacks{
    ...
    public void init(){
        ...
        otherCardArrayList = new ArrayList<OtherCard>();
    ...
    public void setupPagination(){
        ...
        otherAdapter = new OtherAdapter(this,otherCardArrayList, Constants.MAIN);
        loading = false;
        page = 1;
    ...
    private void loadRealEstate() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofit().getOther(page)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(this::handleResponse,this::handleError));
    }

    private void handleResponse(ResponseOther response) {
        Log.d("Respones",response.getOtherfeed().toString());
        errorLayout.setVisibility(View.GONE);
        recyclerView.setVisibility(View.VISIBLE);
        //mainLayout.setVisibility(View.VISIBLE);
        page++;
        otherAdapter.add(response.getOtherfeed());
        loading = false;
    ...
    private void showSnackBarMessage(String message) {
        ...
        Snackbar.make(findViewById(R.id.main_other),message,Snackbar.LENGTH_SHORT).show();
