...
import com.offersbull.adapter.AutomobileAdapter;
import com.offersbull.adapter.HotelAdapter;
import com.offersbull.model.Automobile;
...
public class SingleAutomobileActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_automobile);
        init();
        initListener();
    ...
    private void loadAutomobileById() {
        Log.d("Load","Load realestate");
        progressBar.setVisibility(View.VISIBLE);
        linearContaent.setVisibility(View.GONE);
        linearError.setVisibility(View.GONE);
        mSubscriptions.add(NetworkUtil.getRetrofit().getAutomobileById(id)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(this::handleResponse,this::handleError));
    }

    private void setData(Automobile automobile, ArrayList<AutomobileCard> automobileCardArrayList){
        Picasso.with(this)
                .load(Constants.BASE_IMAGE_URL+automobile.getPath())
                .placeholder(R.mipmap.ic_launcher)
                .error(R.mipmap.ic_launcher)
                .into(imageView);
        tv_title.setText(automobile.getTitle());
        tv_city.setText(automobile.getCity());
        tv_name.setText("By "+automobile.getName());
        CharSequence timeAgo = DateUtils.getRelativeTimeSpanString(
                Long.parseLong(String.valueOf(getLongDate(automobile.getDate()))),
                System.currentTimeMillis(), DateUtils.SECOND_IN_MILLIS);
        tv_date.setText(timeAgo);
        tv_location.setText(automobile.getArea());
        tv_Address.setText(automobile.getAddress());
        tv_type.setText(automobile.getType());

        if (!automobile.getDescription().isEmpty())
            tv_discrip.setText(automobile.getDescription());
        else linear_discription.setVisibility(View.GONE);


        AutomobileAdapter automobileAdapter = new AutomobileAdapter(this,automobileCardArrayList, Constants.SIMILAR);
    ...
    private void handleResponse(ResponseAutomobileSingle response) {
    ...
    private void showSnackBarMessage(String message) {
        ...
        Snackbar.make(findViewById(R.id.main_single_hotel),message,Snackbar.LENGTH_SHORT).show();
