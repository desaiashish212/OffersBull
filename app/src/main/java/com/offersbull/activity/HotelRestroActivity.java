...
public class HotelRestroActivity extends AppCompatActivity implements Paginate.Callbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_restro);
        init();
        setupPagination();
    }
    ...
    public void init(){
        ...
        hotelCardArrayList = new ArrayList<HotelCard>();
    ...
    public void setupPagination(){
        ...
        hotelAdapter = new HotelAdapter(this,hotelCardArrayList, Constants.MAIN);
        loading = false;
        page = 1;
    ...
    private void loadRealEstate() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofit().getHotel(page)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(this::handleResponse,this::handleError));
    }

    private void handleResponse(ResponseHotel response) {
        Log.d("Respones",response.getHotelfeed().toString());
        errorLayout.setVisibility(View.GONE);
        recyclerView.setVisibility(View.VISIBLE);
        //mainLayout.setVisibility(View.VISIBLE);
        page++;
        hotelAdapter.add(response.getHotelfeed());
        loading = false;
    ...
    private void showSnackBarMessage(String message) {
        ...
        Snackbar.make(findViewById(R.id.main_hotel),message,Snackbar.LENGTH_SHORT).show();
