...
public class AutomobileActivity extends AppCompatActivity implements Paginate.Callbacks{
    ...
    public void init(){
        ...
        automobileCardArrayList = new ArrayList<AutomobileCard>();
    ...
    public void setupPagination(){
        ...
        automobileAdapter = new AutomobileAdapter(this,automobileCardArrayList, Constants.MAIN);
        loading = false;
        page = 1;
    ...
    private void loadAutomobile() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofit().getAutomobile(page)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(this::handleResponse,this::handleError));
    }

    private void handleResponse(ResponseAutomobile response) {
        Log.d("Respones",response.getAutomobileCards().toString());
        errorLayout.setVisibility(View.GONE);
        recyclerView.setVisibility(View.VISIBLE);
        //mainLayout.setVisibility(View.VISIBLE);
        page++;
        automobileAdapter.add(response.getAutomobileCards());
        loading = false;
    ...
    private void handleError(Throwable error) {
        ...
        if(automobileCardArrayList.isEmpty()) {
    ...
    private void showSnackBarMessage(String message) {
        ...
        Snackbar.make(findViewById(R.id.main_automobile),message,Snackbar.LENGTH_SHORT).show();
